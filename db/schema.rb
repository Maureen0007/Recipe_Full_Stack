...
ActiveRecord::Schema[8.0].define(version: 2025_10_16_161553) do
  ...
  create_table "meal_planner_recipes", force: :cascade do |t|
    t.bigint "planner_item_id", null: false
    t.bigint "recipe_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["planner_item_id"], name: "index_meal_planner_recipes_on_planner_item_id"
